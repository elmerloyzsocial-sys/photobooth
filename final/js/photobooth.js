class PhotoboothApp {
    constructor() {
        ...
        // Frame selection state - simplified to single frame
        this.selectedFrame = 'celebration';
    ...
    addFrameStyling(ctx, width, height, frameId) {
        // Single celebration frame design
        ...
        ctx.fillText('Thank you for celebrating with us', width / 2, height - 20);
    }
